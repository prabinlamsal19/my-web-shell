...
const createBanner = () : string[] => {
  ...
  const systemInfo = [
    ...
    `<span style="color: ${colors.prompt.host}">Host</span>: Prabin Lamsal Portfolio`,
    `<span style="color: ${colors.prompt.host}">Kernel</span>: 6.6.7-arch1-1`,
    `<span style="color: ${colors.prompt.host}">Uptime</span>: Working Professionally since 2022`,
